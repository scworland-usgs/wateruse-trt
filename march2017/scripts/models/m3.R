...
#'/Users/scworlan/Documents/WAUSP TRT/wateruse-trt/march2017/scripts/models/m3.R'
...
m3.0 <- map2stan(
  alist(
    ...
    mu <- a_state[state_index] + ba_state[state_index]*aridity +
      bpop_state[state_index]*pop_scaled,
...
m3 <- resample(m3.0, warmup=1000, iter=3000, chains=2, cores=2)

saveRDS(m3, "scripts/models/m3.rds")
