...
#'/Users/scworlan/Documents/WAUSP TRT/wateruse-trt/march2017/scripts/models/m2.R'
...
m2 <- resample(m2.0, warmup=1000, iter=5000, chains=2, cores=2)

saveRDS(m2, "scripts/models/m2.rds")
