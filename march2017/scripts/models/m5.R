...
#'/Users/scworlan/Documents/WAUSP TRT/wateruse-trt/march2017/scripts/models/m5.R'
...
m5.0 <- map2stan(
  alist(
    ...
    mu <- a_state[state_index] + ba_state[state_index]*aridity +
      ...
      bta_state[state_index]*t_summer_anom_scaled,
    c(a_state,ba_state,bpop_state,bpa_state,bta_state)[state_index] ~ dmvnormNC(sigma_state, rho_state),
    sigma ~ dcauchy(0,100),
...
m5 <- resample(m5.0, warmup=1000, iter=3000, chains=2, cores=2)

saveRDS(m5, "scripts/models/m5.rds")
